...
expenses = [
    ...
    {"name": "Groceries", "amount": 235.60, "category": "Groceries", "date": 18, "account": "wallet"},    
    {"name": "Gasoline", "amount": 82.90, "category": "Gas/Fuel", "date": 20, "account": "bank_account"},    
    ...
    {"name": "Auto Insurance", "amount": 85.00, "category": "Insurance", "date": 7, "account": "wallet"},    
    {"name": "Life Insurance", "amount": 45.00, "category": "Insurance", "date": 13, "account": "bank_account"},    
    ...
    {"name": "Gasoline", "amount": 60.00, "category": "Gas/Fuel", "date": 38, "account": "credit_card"},
    ...
    {"name": "Car insurance", "amount": 120.00, "category": "Insurance", "date": 42, "account": "credit_card"},
    ...
    {"name": "Fast food", "amount": 25.00, "category": "Dining Out", "date": 54, "account": "wallet"},
    ...
    {"name": "Car insurance", "amount": 210.00, "category": "Insurance", "date": 67, "account": "credit_card"},
    {"name": "Groceries", "amount": 348.75, "category": "Groceries", "date": 68, "account": "wallet"},
    {"name": "Dental checkup", "amount": 140.00, "category": "Medical", "date": 69, "account": "bank_account"},
    ...
    {"name": "Home repairs", "amount": 285.00, "category": "Repairs", "date": 74, "account": "bank_account"},
    ...
    {"name": "New tires", "amount": 600.00, "category": "Repairs", "date": 73, "account": "bank_account"},
...
incomes = [    
    # month #1
    {"name": "Salary", "amount": 6000, "date": 1, "category": "Salary", "account": "bank_account"},    
    {"name": "Bonus", "amount": 1000, "date": 15, "category": "Other Income", "account": "bank_account"},    
    {"name": "Rental Income", "amount": 1200, "date": 5, "category": "Rental Income", "account": "bank_account"},    
    ...
    # month #2
    {"name": "Salary", "amount": 6000, "date": 31, "category": "Salary", "account": "bank_account"},
    ...
    {"name": "Rental Income", "amount": 1200, "date": 35, "category": "Rental Income", "account": "bank_account"},
    {"name": "Tax Refund", "amount": 1000, "date": 50, "category": "Other", "account": "bank_account"},
    {"name": "Gifts", "amount": 300, "date": 55, "category": "Other", "account": "bank_account"},
    {"name": "Lottery Winnings", "amount": 500, "date": 58, "category": "Other", "account": "bank_account"},
    {"name": "Bonus", "amount": 700, "date": 31, "category": "Salary", "account": "bank_account"},
    # month #3
    {"name": "Salary", "amount": 6000, "category": "Primary Income", "date": 61, "account": "bank_account"},
    ...
    {"name": "Rental Income", "amount": 1200, "category": "Rental Income", "date": 65, "account": "bank_account"},
    {"name": "2nd Hand Sales", "amount": 250, "category": "Other", "date": 78, "account": "bank_account"},
    {"name": "Gift", "amount": 150, "category": "Other", "date": 81, "account": "bank_account"},
]