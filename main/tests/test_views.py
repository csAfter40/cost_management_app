...
class TestAccountsListView(TestListViewMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = reverse("main:accounts_list")
        cls.context_list = ["table_template"]
        cls.template = "main/group_table_paginator.html"
        cls.view_function = views.AccountsListView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
        cls.model = Account
        cls.model_factory = AccountFactory
        cls.object_list_name = 'accounts'
...
class TestWorthView(BaseViewTestMixin, TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.context_list = ['stats', 'total_stats', 'currency_details', 'grand_total']
...
class TestCategoryMonthArchiveView(BaseViewTestMixin, TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.test_url = reverse(
            ...
            kwargs={'pk': self.object.id, 'year': 2001, 'month': 1}
        )
        if self.login_required:
            self.client.force_login(self.user)
...
class TestCategoryWeekArchiveView(BaseViewTestMixin, TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.test_url = reverse(
            ...
            kwargs={'pk': self.object.id, 'year': 2001, 'week': 1}
        )
        if self.login_required:
            self.client.force_login(self.user)
...
class TestSubcategoryStatsMonthArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.SubcategoryStatsMonthArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
    ...
    def setUp(self) -> None:
        ...
        AccountTransactionFactory(content_object=account, category=self.object)
        self.test_url = reverse(
                            'main:subcategory_month_archive', 
                            kwargs = {'pk':self.object.id, 'year': 2001, 'month':1}
                        )
...
class TestSubcategoryStatsWeekArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.SubcategoryStatsWeekArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
...
class TestSubcategoryStatsDayArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.SubcategoryStatsDayArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
...
class TestAccountDetailAllArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.AccountDetailAllArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
...
class TestAccountDetailMonthArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.AccountDetailMonthArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
    ...
    def setUp(self) -> None:
        ...
        self.object = AccountFactory(user=self.user)
        self.test_url = reverse(
                            'main:account_month_archive', 
                            kwargs = {'pk':self.object.id, 'year': 2001, 'month':2}
                        )

class TestAccountDetailWeekArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.AccountDetailWeekArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
    ...
    def setUp(self) -> None:
        ...
        self.object = AccountFactory(user=self.user)
        self.test_url = reverse(
                            'main:account_week_archive', 
                            kwargs = {'pk':self.object.id, 'year': 2001, 'week':2}
                        )

class TestAccountDetailDayArchiveView(UserFailTestMixin, BaseViewTestMixin, TestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.test_url = ''
        cls.view_function = views.AccountDetailDayArchiveView.as_view()
        cls.login_required = True
        cls.user_factory = UserFactoryNoSignal
