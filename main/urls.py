...
urlpatterns = [
    ...
    path('categories/expense/<pk>/edit', views.EditExpenseCategory.as_view(), name='edit_expense_category'),
    path('categories/expense/<pk>/del', views.DeleteExpenseCategory.as_view(), name='delete_expense_category'),
    path('categories/income/<pk>/edit', views.EditIncomeCategory.as_view(), name='edit_income_category'),
    path('categories/income/<pk>/del', views.DeleteIncomeCategory.as_view(), name='delete_income_category'),
