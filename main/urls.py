...
urlpatterns = [
    ...
    path("cards/<int:pk>/date", views.CreditCardDetailAllArchiveView.as_view(), name="credit_card_all_archive"),
    path("cards/<int:pk>/date/<int:year>", views.CreditCardDetailYearArchiveView.as_view(), name="credit_card_year_archive"),
    path("cards/<int:pk>/date/<int:year>/<int:month>", views.CreditCardDetailMonthArchiveView.as_view(), name="credit_card_month_archive"),
    path("cards/<int:pk>/date/<int:year>/week/<int:week>", views.CreditCardDetailWeekArchiveView.as_view(), name="credit_card_week_archive"),
    path("cards/<int:pk>/date/<int:year>/<int:month>/<int:day>", views.CreditCardDetailDayArchiveView.as_view(), name="credit_card_day_archive"),
